...
import HeadshotReels from "@/components/HeadshotReels";
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
              <div className="space-y-2 flex-1">
                ...
                <p className="text-ink-mid leading-relaxed">
                  Every month we raffle a free professional headshot session for one member of our community. Follow us on Instagram to enter and stay posted on the next draw.
                </p>
              </div>
              <a
